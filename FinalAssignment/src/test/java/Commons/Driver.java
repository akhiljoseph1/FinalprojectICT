...
//        return driver;
            WebElement selectCity=driver.findElement(By.xpath("//input[@id='inp_RegionSearch_top']"));
            selectCity.sendKeys("Kochi");
            selectCity.sendKeys(Keys.ENTER);
            WebDriverWait wait=new WebDriverWait(driver,20);
            WebElement waitElement=wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("wzrk-cancel")));
        }
